            ...
            <div class="collapse navbar-collapse justify-content-between">
                ...
                <ul class="navbar-nav header-right">
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        <a class="nav-link bell bell-link" href="#" id="open-chatbox">
                         <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span 
                                ...
                                @if(Auth::user()->chatbox()->first()->unreadMessages->count() == 0) style="display:none;" @endif
                                id="unread-messages-count"
                            >
                                {{ Auth::user()->chatbox()->first()->unreadMessages->count() }}
                            </span>
                        </a>
                    </li>
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <a class="dropdown-item ai-icon" href="{{ route('member.account.index') }}">
