    ...
    <div class="card-header border-bottom border-primary">
        <div class="form-head d-flex align-items-start justify-content-between gap-2 w-100">    
            <div class="me-auto flex-shrink-0">
                <h2 class="mb-0">Les contacts</h2>
                <p class="text-light">Liste contacts</p>
            </div>	
        </div>
    </div>
    {{-- /Content Header --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a title="Mettre à la corbeille le message" href="{{ route('admin.contacts.soft-delete', ['contact' => $contact]) }}" class="btn btn-outline-danger shadow btn-xs sharp delete-row"><i class="fa fa-trash"></i></a>
                                </div>												
                            </td>
                        </tr>
                    @endforeach										
