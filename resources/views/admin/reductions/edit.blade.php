...
@section('title', 'Modifier le code de réduction')
...
<div class="row page-titles mb-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Modifier le code de réduction</a></li>
    </ol>
</div>
{{-- /Breadcrumbs --}}
...
<div class="card border border-4 border-primary">
     ...
     <div class="card-header border-bottom border-primary flex-column align-items-start p-4">
        ...
        <div class="card-description">
            <p class="text-muted  mb-0 font-weight-light">
                Depuis cet espace, vous pouvez modifier un code de réduction.
            </p>
        </div>
    </div>
    {{-- /Content Header --}}
    ...
    <div class="card-body mb-4 mt-4">
        <form action="{{ route('admin.reductions.update', ['reduction' => $reduction]) }}" method="post">
            @csrf
