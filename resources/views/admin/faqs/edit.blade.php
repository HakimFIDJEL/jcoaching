...
<div class="row page-titles mb-0">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="javascript:void(0)">Modifier une faq</a></li>
    </ol>
</div>
{{-- /Breadcrumbs --}}
    ...
    <div class="card-header border-bottom border-primary flex-column align-items-start p-4">
        ...
        <div class="card-description">
            <p class="text-muted  mb-0 font-weight-light">
                Depuis cet espace, vous pouvez modifier une faq de votre application.
            </p>
        </div>
    </div>
    {{-- /Content Header --}}
