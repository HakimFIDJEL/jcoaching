    ...
    <div class="card-header border-bottom border-primary">
        <div class="form-head d-flex align-items-start justify-content-between gap-2 w-100">    
            <div class="me-auto flex-shrink-0">
                <h2 class="mb-0">Les tarifs</h2>
                <p class="text-light">Liste des tarifs</p>
            </div>	
            <span>
                <a href="{{ route('admin.pricings.create') }}" class="btn btn-primary ">+ Ajouter un tarif</a>
            </span>
        </div>
    </div>
    {{-- /Content Header --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a title="Mettre à la corbeille le tarif" href="{{ route('admin.pricings.soft-delete', ['pricing' => $pricing]) }}" class="btn btn-outline-danger shadow btn-xs sharp delete-row"><i class="fa fa-trash"></i></a>
                                </div>												
                            </td>
                        </tr>
                    @endforeach										
